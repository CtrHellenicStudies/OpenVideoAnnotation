videojs.Youtube = videojs.MediaTechController.extend({
    init: function (a, b, c) {
    console.log("ini youtube");
        videojs.MediaTechController.call(this, a, b, c);
        this.features.fullscreenResize = !0;
        this.player_ = a;
        this.player_el_ = document.getElementById(this.player_.id());
        if ("undefined" != typeof b.source)
            for (var e in b.source) this.player_.options()[e] = b.source[e];
        ...
        if ("undefined" != typeof this.videoId && !this.player_.options().ytcontrols) {
            "undefined" ==
                typeof this.player_.poster() && this.player_.poster("http://img.youtube.com/vi/" + this.videoId + "/0.jpg");
            var d = this;
            setTimeout(function () {
                d.player_.posterImage.el().style.backgroundSize = "cover"
            }, 50)
        }
        ...
        "undefined" == typeof a.list && delete a.list;
        this.player_.options().autoplay && (this.playOnReady = !0);
        "file:" != window.location.protocol && (a.origin = window.location.protocol + "//" + window.location.hostname);
        this.el_.src = "http://www.youtube.com/embed/" + this.videoId + "?" + videojs.Youtube.makeQueryString(a);
        this.player_.options().ytcontrols && (d = this, setTimeout(function () {
            var a = d.player_.bigPlayButton.el();
            a.parentNode.removeChild(a);
            a = d.player_.controlBar.el();
            a.parentNode.removeChild(a)
        }, 50));
        videojs.Youtube.apiReady ? this.loadYoutube() : (videojs.Youtube.loadingQueue.push(this), videojs.Youtube.apiLoading || (a = document.createElement("script"), a.src = "http://www.youtube.com/iframe_api", b = document.getElementsByTagName("script")[0],
            b.parentNode.insertBefore(a, b), videojs.Youtube.apiLoading = !0))
    }
});
videojs.Youtube.prototype.dispose = function () {
    this.el_ && this.el_.parentNode.removeChild(this.el_);
    this.ytplayer && this.ytplayer.destroy();
    videojs.MediaTechController.prototype.dispose.call(this)
};
videojs.Youtube.prototype.src = function (a) {
    this.ytplayer.loadVideoById({
        videoId: videojs.Youtube.parseVideoId(a),
        list: videojs.Youtube.parsePlaylist(a)
    })
};
...
videojs.Youtube.prototype.onReady = function () {
    ...
    this.playOnReady && this.ytplayer.playVideo()
};
...
videojs.Youtube.parseVideoId = function (a) {
    if ((a = a.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/)) && 11 == a[2].length) return a[2]
};
videojs.Youtube.parsePlaylist = function (a) {
    a = a.match(/[?&]list=([^#\&\?]+)/);
